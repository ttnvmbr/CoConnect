...
if (isset($_POST['submit'])) {
    ...
    $job = mysqli_escape_string($db, $_POST['job']);
    ...
    $query = "UPDATE external_contacts
                  SET name = '$name', email = '$email', phone = '$phone', description = '$description', job = '$job', location = '$location'
                  WHERE id = '$contactId'";
                ...
                <div class="card-title justify-content-center">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="job" type="text" name="job" value="<?= $contact['job'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label for="location">Locatie</label>
                                <input class="form-control" id="location" type="text" name="location" value="<?= $contact['location'] ?>"/>
                            </div>
