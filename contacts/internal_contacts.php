...
<h1>Interne contacten</h1>
    <a class="no-deco-link" href="new_internal.php"><i class="mr-1 fa fa-plus"></i>Nieuw intern contactpersoon</a>
<table class="table table-light rounded" style="border-collapse:collapse;" id="contacts">
    ...
    <tbody>
    <?php foreach ($internal_contacts as $contact) { ?>
        <tr>
            <td scope="col"><?= $contact['name']; ?></td>
            <td scope="col"><?= $contact['function']; ?></td>
            <td><a class="no-deco-link fa fa-eye" href="show_internal.php?id=<?= $contact['id'];?>"></a></td>

            <!--            if admin-->
            <td><a class="no-deco-link fa fa-trash-o" href="internal_delete.php?id=<?= $contact['id'];?>"></a></td>
            <td><a class="no-deco-link fa fa-edit" href="internal_edit.php?id=<?= $contact['id'];?>"></a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
