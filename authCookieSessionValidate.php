...
// Check if loggedin session exists
else if (! empty($_COOKIE["login"]) && ! empty($_COOKIE["company"]) &&  ! empty($_COOKIE["random_password"]) && ! empty($_COOKIE["random_selector"])) {
    ...
    $userToken = $auth->getTokenByUsername($_COOKIE["login"],$_COOKIE["company"],0);
